...
const TestTakerInfo: React.FC<TesttoolProps> = ({ showTool }) => {
  ...
  return (
    <>
        ...
        <Box sx={{ marginLeft: '50px', width: '90vw', marginTop: '56px' }}>
          ...
          <Box sx={{ width: '65vw', gap: '20px', marginTop: '20px' }}>
            ...
            <span style={{ marginLeft: '20px' }}>
              After you answer a question, select <b>Next</b>. You may still return to the question and change your answer after selecting <b>Next</b>.
            </span>
            <br />
            <Divider sx={{ margin: '20px' }} />
            <Button variant="contained">Help</Button>
            <span style={{ marginLeft: '20px' }}>
              By selecting <b>Help</b> you can get information on different topics. The topics are presented on different tabs. You are now in <b>Help</b>.
            </span>
          </Box>
      ...
      ) : (<Box sx={{ width: '60%', marginLeft: '50px', padding: '20px', backgroundColor: '#f9f9f9' }}>
        <Typography variant="h4" component="h1" gutterBottom>
          Test Taker Information
        </Typography>
        <Typography variant="body1" gutterBottom>
          Please check the following information, if this is correct, select Continue. If this is incorrect, select Exit.
        </Typography>
        ...
        <Card sx={{ margin: '20px 0' }}>
          <CardContent>
            <Typography variant="body1">
              Test: {
            (testType === TestType.FULL_LENGTH_TEST) ? "GRE Practice Test 1"
            : "Sectional Practice Test"
          }
          </Typography>
            {firstName && lastName && <Typography variant="body1">Name: {(firstName + " " + lastName) || "N/A"}</Typography>}
            {/* <Typography variant="body1">Test Taker ID: {userId || "N/A"}</Typography> */}
          </CardContent>
        </Card>

        <Box sx={{ display: 'flex', justifyContent: 'flex-start', marginTop: '20px', gap: '20px' }}>
